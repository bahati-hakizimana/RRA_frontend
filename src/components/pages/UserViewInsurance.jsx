...
function UserViewInsurance() {
  ...
  return (
    <>
      <h1 className='text-center text-black text-xl capitalize mb-4'>Insurance</h1>
      <div className="flex justify-between mb-4">
        ...
        {/* <Link to="/admin/addinstitutions" className="px-4 py-2 bg-purple-400 text-white rounded-full hover:bg-gray-500 hover:text-white">Add Institution</Link> */}
      </div>
...
export default UserViewInsurance;
