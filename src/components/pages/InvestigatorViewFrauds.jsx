...
function InvestigatorFraudsView() {
  ...
  return (
    <>
      <h1 className='text-center text-black text-xl capitalize mb-4'>Insurance Frauds</h1>
      <div className="flex justify-between mb-4">
        ...
        {/* <Link to="/admin/addinstitutions" className="px-4 py-2 bg-purple-400 text-white rounded-full hover:bg-gray-500 hover:text-white">Add Insurance Member</Link> */}
      </div>
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            {filteredData.length > 0 ? (
              ...
              <tr>
                <td colSpan="4" className="px-6 py-4 text-center">No Insurance Frauds found</td>
              </tr>
            )}
          </tbody>
        </table>
...
export default InvestigatorFraudsView;
