...
function EmployeeViewPredictions() {
  ...
  return (
    <>
      ...
      <div className="flex justify-between mb-4">
        ...
        <Link to="/employee/predictInsurance" className="px-4 py-2 bg-purple-400 text-white rounded-full hover:bg-gray-500 hover:text-white">Predict Insurance</Link>
      </div>
...
export default EmployeeViewPredictions;
