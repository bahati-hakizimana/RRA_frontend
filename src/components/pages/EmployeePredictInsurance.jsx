...
const EmployeePredictInsurance = () => {
  ...
  return (
    <>
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-white">
        ...
        {/* <small className="mt-1.5 text-center">Insurance</small> */}
        <h1 className='text-center text-black text-xl capitalize mb-4'>Verify Insurance</h1>
...
export default EmployeePredictInsurance;
