...
function Sidebar() {
  ...
  const Sidebar_Links = [
    { id: 1, name: 'Dashboard', path: '/employee', icon: <MdDashboard /> },
    {id: 1, name: 'Our Members', path: '/employee/insuranceMember', icon: <MdDashboard /> },
    { id: 6, name: 'Fraud', path: '/employee/frauds', icon: <FaCommentDots /> },
    { id: 6, name: 'Investigator', path: '/employee/investigator', icon: <FaCommentDots /> },
  ];
